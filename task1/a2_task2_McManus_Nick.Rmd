...
coeffs_blr1_tidy %>% 
  kable(caption = "**Table 7.** Summary statistics for BLR model 1",
        col.names = c("Variable", "Coefficient", "Standard error", "Statistic", "p-value")) %>% 
  kable_styling(full_width = FALSE,
                bootstrap_options = "hover",
                position = "left")
...
# output nice table
blr1_accuracy %>% 
  kable(caption = "**Table 8.** Classification accuracy for Model 1.",
        col.names = c("Species", 
